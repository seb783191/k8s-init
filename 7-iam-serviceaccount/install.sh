...
ENV=$1
NAMESPACE=bcloud-operator-system
SERVICE_ACCOUNT_NAME=bcloud-operator-controller-manager
file=trust-$ENV.json
...
aws iam create-role --role-name $ENV-eksctl-bcloud-operator --assume-role-policy-document file://$file --description "role for bcloud"
